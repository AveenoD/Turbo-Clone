          ...
          <a className="card card-full" href="/">
            ...
            <div className="card-content">
              <div>
                ...
                <p className="card-description">
                  Learning AI actively works alongside you — editing your doc, highlighting issues, adding AI comments.
                </p>
              </div>
              <div className="card-image-wrapper" style={{ justifyContent: 'flex-start' }}>
                <div className="card-image-mask-left">
                  <img 
                    alt="AI Learning actively editing and commenting on a document"
                    style={{ height: 'auto' }}
                    src="/tab-image.png"
                  />
                </div>
              ...
              <p className="card-footer-text">
                AI Learning is available to chat all the time —{' '}
          ...
          <a className="card" href="/">
            ...
            <div className="card-content">
              <div>
                ...
                <p className="card-description">
                  Formerly, AiLearn - students love us. Generate quizzes, podcasts, flashcards from your notes.
                </p>
              </div>
          ...
          <article className="card">
            ...
            <div className="card-content">
              <div>
                ...
                <p className="card-description">
                  Learning AI works on the web and mobile. Desktop app coming next month!
                </p>
              </div>
              <div className="devices-image-wrapper">
                <img 
                  alt="Learning AI synced across laptop, tablet, and phone devices"
                  loading="lazy"
